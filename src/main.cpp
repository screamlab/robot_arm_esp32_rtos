...
trajectory_msgs__msg__JointTrajectoryPoint arm_msg_sub;
rclc_executor_t arm_executor_sub;

// publisher
rcl_publisher_t arm_pub;
trajectory_msgs__msg__JointTrajectoryPoint arm_msg_pub;
rclc_executor_t arm_executor_pub;
